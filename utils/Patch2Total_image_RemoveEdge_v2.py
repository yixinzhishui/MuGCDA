...
if __name__ == '__main__':
    input_fileDir = r"/data_zs/data/data_cj_images/test/p165_r071_l8_20151015.img"  #E:\data\projects_and_topic\LULC_HuangHua\image_patch_GuiXi\360681BJ2+AP0DOM02_2_1.tif
    output_fileDir = r"/data_zs/data/test_pred/test_0824_cj"  #r"E:\data\projects_and_topic\LULC_HuangHua\pred_patch_GuiXi"
    ...
    transform = transforms.Compose([
        transforms.ToTensor(),
        transforms.Normalize([0.11260208, 0.10551751, 0.10492918, 0.16211523, 0.16276681, 0.12847708], [0.07017841, 0.06570993, 0.06758178, 0.103969775, 0.11307224, 0.090447314]),
    ])
