...
def parse_args():
    ...
    parser.add_argument('--config-file', default= r'/data_zs/code/loveDA/pytorchAI_segmentation_loveda/configs/vaihingen_potsdam/loveda_potsdam2vaihingen_segformer.yaml', metavar="FILE", #/code/python/pytorch/sandong/pytorchAI_segmentation_sandong/configs/sandong_segformer.yaml    #/data_zs/code/sandong/pytorchAI_segmentation_sandong/configs/sandong_segformer.yaml
