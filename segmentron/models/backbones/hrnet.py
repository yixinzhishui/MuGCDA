...
from __future__ import absolute_import   #https://blog.csdn.net/caiqiiqi/article/details/51050800
...
from ...config import cfg    #from . import XXX:https://blog.csdn.net/qq_34105362/article/details/80520468
...
class HighResolutionNet(nn.Module):                        #详细网路结构图：https://www.cnblogs.com/dilthey/p/11182948.html
    ...
    def forward(self, x):
        ...
        for i in range(self.stage3_cfg['NUM_BRANCHES']):
            if self.transition2[i] is not None:
                x_list.append(self.transition2[i](y_list[-1]))    #y_list[-1]是不是有问题
            else:
