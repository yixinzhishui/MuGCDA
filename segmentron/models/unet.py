...
@MODEL_REGISTRY.register()    #函数修饰符@：https://www.cnblogs.com/gdjlc/p/11182441.html
...
class Up(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, bilinear=True):
        ...
        if bilinear:
            ...
            self.up = nn.ConvTranspose2d(in_channels // 2, in_channels // 2, kernel_size=2, stride=2)   #https://blog.csdn.net/e01528/article/details/84667302
