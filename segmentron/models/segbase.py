...
from segmentron.models.backbones import get_segmentation_backbone
from segmentron.data.dataloader import datasets
from segmentron.modules import get_norm
...
class SegBaseModel(nn.Module):
    ...
    def __init__(self, need_backbone=True):
        ...
        self.nclass = cfg.DATASET.NUM_CLASSES#datasets[cfg.DATASET.NAME].NUM_CLASS
